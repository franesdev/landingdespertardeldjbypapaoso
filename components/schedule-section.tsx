...
export function ScheduleSection() {
  return (
    <section id="programa" className="py-24 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-primary font-semibold uppercase tracking-wide text-sm">Programa completo</span>
          <h2 className="font-display text-5xl md:text-6xl text-foreground mt-4">5 DÍAS QUE CAMBIARÁN TODO</h2>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                <div className="flex-shrink-0">
                  <div className="bg-primary text-primary-foreground font-display text-2xl px-6 py-3 rounded-lg text-center">
                    {item.day}
                  </div>
                </div>
